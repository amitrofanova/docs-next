...
Может использоваться, чтобы создать [`ref`](#ref) для свойства на исходном реактивном объекте. После можно передавать ref-ссылку, сохраняя реактивную связь с исходным свойством.
